<template>
  <div>
    <div id="bac"></div>
    <div id="yinyan">
      <h2 id="chunfeng">春风不及 樱花未至<br>你未出现 美好初始</h2>
      <div id="play" class="btn1 fas fa-play">
        <div id="bji" class="bj"></div>
        <div class="fr" id="fronclick" @click="funclick"></div>
      </div>
    </div>
    <div id="boxup"></div>
    <div id="box">
      <div id="boxl">F L</div>
      <div id="boxr"><br><h3>听到了吗</h3><br>触击过后那一声钢琴键,这是我初见你时的心声。<br><br>我的世界已开满花，每天都想为你尝试一些我未见过的事.....你愿意陪我吗。<br><br>所以.....试着按动第一个a键吧。</div>
    </div>
    <div id="box1"></div>
  </div>
</template>
...
const funclick = ref(() => {
  ...
  let x = document.createElement("audio");
    x.setAttribute("src", 'src/video/55.mp3');
...
let a=[
    {name:"A",yin:8, str:"<br><br><br>山是故人眸，柳是纤纤手，我步步都回头，遇见你之后我步步都难走。<br><br>还有....,其他的键<br><br>那些都是关于你的声音。以及，找一下声音里关于你的线索。"},
    ...
    {name:"I" ,yin:3, str:"<br><br>I'm waiting . <br>什么？ <br>爱慕未停 <br><br>"},
    ...
    {name:"L" ,yin:8, str:"<br><br><br><br>我要和你谈谈，<br><br>不灭的鬼怪与神论，人间的烟火与车窗，六月的第五个黄昏，<br><br>和一场恋爱。"},
...
function fl(e)
{
    ...
    if((key<='z'&&key>='a')||(key<='Z'&&key>='A'))//避免大小写的错误
    {
        ...
        s=s+p.name;
        let x = document.createElement("audio");
        x.setAttribute("src", `src/video/${p.yin}.mp3`);
        x.setAttribute("autoplay","autoplay");
        ...
        if(s.indexOf("XIAOLUXIAOLUWXHN")!=-1&&records==0)
        {
            setTimeout(function()
            {
                ...
                x.setAttribute("src", 'src/video/snjxh.mp3');
                x.setAttribute("autoplay","autoplay");
